...
export const CreateTodoForm = () => {
  ...
  return (
    <form className="group flex items-center justify-between rounded-12 border border-gray-200 py-[7px] pr-[11px] focus-within:border-gray-400">
      ...
      <button
        ...
        className="items-center rounded-full bg-gray-700 px-5 py-2 text-sm font-bold text-white "
        onClick={() => {
          createTodo({
            body: todoBody,
          })
